...
class CommonWidget {
  ...
  Widget commonTextField(
      {required TextEditingController controller, //required is added
      required String hintText, //required is added
        ...
        children: <Widget>[
          ...
          Center(
            child: Container(
              ...
              height: lines == null ? 60 : 100,
              decoration: BoxDecoration(
                  border: Border(
                      bottom: BorderSide(width: 1, color: Colors.white))),
              child: TextField(
                maxLines: lines, // ?? 1 is removed
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  ...
                                  scale: 3,
                                  image: NetworkImage(
                                    (snapshot.data() as dynamic)["logoUri"].toString(),
                                  ),
                                )),
                          ),
                          Container(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Center(
                                      child: Text(
                                        "${(snapshot.data() as dynamic)["salary"]} per month", // ?? " " is removed
                                        style: TextStyle(
                                          //         color: Color(CommonStyle().lightYellowColor),
                                          color: Colors.black,
                                          fontSize: 13,
                                            ...
                                            Text(
                                              (postType.contains("Offers")
                                                      ? (snapshot.data() as dynamic)[
                                                          "cashbackAmount"]
                                                      : (snapshot.data() as dynamic)["reward"]) ??
                                                  "0",
                                              style: TextStyle(
                                                  color: Colors.yellow),
                                            )
