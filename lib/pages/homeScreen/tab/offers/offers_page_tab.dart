...
class OffersPageTab extends StatefulWidget {
  ...
  OffersPageTab(
      {required this.docList, required this.isRedirectFromProfile}); //required
...
class _OffersPageTabState extends State<OffersPageTab>
  ...
  int iscomplete = 1;
  late List<DocumentSnapshot> cashbackDocumentList;
  late List<DocumentSnapshot> on500DocumentList;
  late List<DocumentSnapshot> couponsDocumentList;
