...
class TournamentAdminDetailsPage extends StatefulWidget {
  List taskUserList;
  String docId;
  TournamentAdminDetailsPage(
      {required this.taskUserList, required this.docId}); //required is added
...
class _TournamentAdminDetailsPageState extends State<TournamentAdminDetailsPage>
  ...
  late String _localPath; //late3 is added
  bool isShowDownloadBar = false;
  late String phoneNo; //late is added
